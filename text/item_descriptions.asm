...
_TM04Description::
	text "TM-04"
	line "WHIRLWIND"
	para "Blows away the foe"
	line "and ends battle."
	prompt

_TM05Description::
	text "TM-05"
	line "MEGA KICK"
	para "A powerful kicking"
	line "attack."
	prompt
