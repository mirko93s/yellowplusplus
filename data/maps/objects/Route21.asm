Route21_Object:
	...
	def_object_events
	object_event  4, 24, SPRITE_FISHER, STAY, LEFT, 1, OPP_FISHER, 8
	...
	object_event 14, 56, SPRITE_FISHER, STAY, LEFT, 8, OPP_FISHER, 10
	object_event 17, 57, SPRITE_FISHER, STAY, RIGHT, 9, OPP_FISHER, 11
