Route19_Object:
	...
	object_event  8, 43, SPRITE_SWIMMER, STAY, LEFT, 7, OPP_BEAUTY, 8
	object_event 11, 43, SPRITE_SWIMMER, STAY, RIGHT, 8, OPP_BEAUTY, 9
	object_event  9, 42, SPRITE_SWIMMER, STAY, UP, 9, OPP_SWIMMER, 8
	object_event 10, 44, SPRITE_SWIMMER, STAY, DOWN, 10, OPP_BEAUTY, 10
