VermilionGym_Object:
	...
	def_object_events
	object_event  5,  1, SPRITE_LTSURGE, STAY, DOWN, 1, OPP_LT_SURGE, 1
	object_event  9,  6, SPRITE_GENTLEMAN, STAY, LEFT, 2, OPP_GENTLEMAN, 1
	object_event  3,  8, SPRITE_SUPER_NERD, STAY, LEFT, 3, OPP_ROCKER, 1
	object_event  0, 10, SPRITE_SAILOR, STAY, RIGHT, 4, OPP_SAILOR, 1
