CeladonMansion1F_Object:
	...
	def_object_events
	object_event  0,  5, SPRITE_MEOWTH, STAY, RIGHT, 1 ; person
	object_event  1,  5, SPRITE_GRANNY, STAY, DOWN, 2 ; person
	object_event  1,  8, SPRITE_FAIRY, WALK, LEFT_RIGHT, 3 ; person ; clefairy
	object_event  4,  4, SPRITE_NIDORANF, WALK, UP_DOWN, 4 ; person
