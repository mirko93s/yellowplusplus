SilphCo4F_Object:
	...
	object_event  9, 14, SPRITE_ROCKET, STAY, RIGHT, 2, OPP_ROCKET, 19
	object_event 14,  6, SPRITE_SCIENTIST, STAY, LEFT, 3, OPP_SCIENTIST, 4
	object_event 26, 10, SPRITE_ROCKET, STAY, UP, 4, OPP_ROCKET, 20
