Route10_Object:
	...
	object_event  3, 57, SPRITE_HIKER, STAY, UP, 2, OPP_HIKER, 8
	object_event 14, 64, SPRITE_SUPER_NERD, STAY, LEFT, 3, OPP_POKEMANIAC, 2
	object_event  7, 25, SPRITE_COOLTRAINER_F, STAY, LEFT, 4, OPP_JR_TRAINER_F, 6
	object_event  3, 61, SPRITE_HIKER, STAY, DOWN, 5, OPP_HIKER, 9
	object_event  7, 54, SPRITE_COOLTRAINER_F, STAY, DOWN, 6, OPP_JR_TRAINER_F, 7
