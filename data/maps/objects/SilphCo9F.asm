SilphCo9F_Object:
	...
	object_event  2,  4, SPRITE_ROCKET, STAY, UP, 2, OPP_ROCKET, 30
	object_event 21, 13, SPRITE_SCIENTIST, STAY, DOWN, 3, OPP_SCIENTIST, 9
	object_event 13, 16, SPRITE_ROCKET, STAY, UP, 4, OPP_ROCKET, 31
