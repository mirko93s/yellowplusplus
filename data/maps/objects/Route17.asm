Route17_Object:
	...
	object_event  4, 18, SPRITE_BIKER, STAY, UP, 3, OPP_BIKER, 11
	object_event  7, 32, SPRITE_BIKER, STAY, LEFT, 4, OPP_BIKER, 12
	object_event 14, 34, SPRITE_BIKER, STAY, RIGHT, 5, OPP_BIKER, 13
	...
	object_event  5, 98, SPRITE_BIKER, STAY, LEFT, 9, OPP_BIKER, 14
	object_event 10, 118, SPRITE_BIKER, STAY, DOWN, 10, OPP_BIKER, 15
