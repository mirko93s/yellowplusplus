Route8_Object:
	...
	object_event 13,  9, SPRITE_GAMBLER, STAY, UP, 2, OPP_GAMBLER, 1
	object_event 42,  6, SPRITE_SUPER_NERD, STAY, UP, 3, OPP_SUPER_NERD, 4
	object_event 26,  3, SPRITE_COOLTRAINER_F, STAY, LEFT, 4, OPP_LASS, 14
	object_event 26,  4, SPRITE_SUPER_NERD, STAY, RIGHT, 5, OPP_SUPER_NERD, 5
	object_event 26,  5, SPRITE_COOLTRAINER_F, STAY, LEFT, 6, OPP_LASS, 15
	object_event 26,  6, SPRITE_COOLTRAINER_F, STAY, RIGHT, 7, OPP_LASS, 16
	object_event 46, 13, SPRITE_GAMBLER, STAY, DOWN, 8, OPP_GAMBLER, 2
	object_event 51, 12, SPRITE_COOLTRAINER_F, STAY, LEFT, 9, OPP_LASS, 17
