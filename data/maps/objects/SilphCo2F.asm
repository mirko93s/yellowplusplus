SilphCo2F_Object:
	...
	object_event  5, 12, SPRITE_SCIENTIST, STAY, DOWN, 2, OPP_SCIENTIST, 1
	object_event 24, 13, SPRITE_SCIENTIST, STAY, LEFT, 3, OPP_SCIENTIST, 2
	object_event 16, 11, SPRITE_ROCKET, STAY, UP, 4, OPP_ROCKET, 16
	object_event 24,  7, SPRITE_ROCKET, STAY, UP, 5, OPP_ROCKET, 17
