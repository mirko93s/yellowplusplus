Route25_Object:
	...
	object_event 24,  4, SPRITE_COOLTRAINER_M, STAY, DOWN, 3, OPP_JR_TRAINER_M, 4
	object_event 18,  8, SPRITE_COOLTRAINER_F, STAY, RIGHT, 4, OPP_LASS, 10
	object_event 32,  3, SPRITE_YOUNGSTER, STAY, LEFT, 5, OPP_YOUNGSTER, 7
	object_event 37,  4, SPRITE_COOLTRAINER_F, STAY, DOWN, 6, OPP_LASS, 11
